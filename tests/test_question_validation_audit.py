...
class QuestionValidationAuditTests(unittest.TestCase):
    def test_active_scope_summary_reflects_expanded_runtime_boundary(self):
        ...
        self.assertEqual(report["scope_summary"]["scope"], "local_parsed_bereishis_1_1_to_3_24")
        self.assertEqual(report["scope_summary"]["range"]["end"], {"perek": 3, "pasuk": 24})
        self.assertEqual(report["scope_summary"]["pesukim_count"], 80)
