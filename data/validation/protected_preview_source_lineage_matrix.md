...
|---|---|---|---|---|---|---|---|
| `g2ppacket_p2_001` | `g2ppcand_p2_001` | Bereishis 2:4 | `basic_noun_recognition` | `false` | `false` | `false` | `g2p2_002` |
| `g2ppacket_p2_002` | `g2ppcand_p2_002` | Bereishis 2:5 | `basic_noun_recognition` | `false` | `false` | `false` | `g2p2_003` |
| `g2ppacket_p2_003` | `g2ppcand_p2_003` | Bereishis 2:8 | `basic_noun_recognition` | `false` | `false` | `false` | `g2p2_006` |
| `g2ppacket_p2_004` | `g2ppcand_p2_004` | Bereishis 2:9 | `basic_noun_recognition` | `false` | `false` | `false` | `g2p2_007` |
| `g2ppacket_p2_005` | `g2ppcand_p2_005` | Bereishis 2:11 | `basic_noun_recognition` | `false` | `false` | `false` | `g2p2_009` |
| `g2ppacket_p2_006` | `g2ppcand_p2_006` | Bereishis 2:15 | `basic_noun_recognition` | `false` | `false` | `false` | `g2p2_014` |
| `g2ppacket_p2_007` | `g2ppcand_p2_007` | Bereishis 2:19 | `basic_noun_recognition` | `false` | `false` | `false` | `g2p2_016` |
...
| `not_available` | `not_available` | not_available | `not_available` | `false` | `false` | `false` | `not_available` |
| `not_available` | `not_available` | not_available | `not_available` | `false` | `false` | `false` | `not_available` |
| `not_available` | `not_available` | not_available | `not_available` | `false` | `false` | `false` | `not_available` |
| `not_available` | `not_available` | not_available | `not_available` | `false` | `false` | `false` | `not_available` |
