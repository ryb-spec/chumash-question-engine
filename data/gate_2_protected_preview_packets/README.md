# Gate 2 Internal Protected-Preview Packets

This layer contains internal protected-preview packet artifacts only.

This is not reviewed-bank content. This is not runtime data. This is not student-facing content.

This packet is for internal/Yossi/teacher review only. Every item still requires post-preview review before any broader use.

## Bereishis Perek 2 artifacts

- `data/gate_2_protected_preview_packets/bereishis_perek_2_internal_protected_preview_packet.tsv`
- `data/gate_2_protected_preview_packets/reports/bereishis_perek_2_internal_protected_preview_packet.md`
- `data/gate_2_protected_preview_packets/reports/bereishis_perek_2_internal_protected_preview_packet_generation_report.md`
- `data/gate_2_protected_preview_packets/reports/bereishis_perek_2_round_2_completion_report.md`
- `data/gate_2_protected_preview_packets/reports/bereishis_perek_2_internal_protected_preview_packet_excluded_preserved_report.md`

## Bereishis Perek 3 artifacts

- `data/gate_2_protected_preview_packets/bereishis_perek_3_internal_protected_preview_packet.tsv`
...
- Scope: the 3 limited-readiness items only; g2ppcand_p3_004 remains blocked from the active review lane.
- Safety: non-runtime, non-reviewed-bank, non-student-facing, no item content revision, and no new protected-preview packet creation.


## Bereishis Perek 3 completion and Perek 4 launch gate

- Observation intake MD: `data/gate_2_protected_preview_packets/reports/bereishis_perek_3_limited_post_preview_observation_intake.md`
- Observation intake TSV: `data/gate_2_protected_preview_packets/reports/bereishis_perek_3_limited_post_preview_observation_intake.tsv`
- Observation intake instructions: `data/gate_2_protected_preview_packets/reports/bereishis_perek_3_limited_post_preview_observation_intake_instructions.md`
- Completion status dashboard MD: `data/gate_2_protected_preview_packets/reports/bereishis_perek_3_completion_status_dashboard.md`
- Completion status dashboard JSON: `data/gate_2_protected_preview_packets/reports/bereishis_perek_3_completion_status_dashboard.json`
- Risk register MD: `data/gate_2_protected_preview_packets/reports/bereishis_perek_3_risk_register.md`
