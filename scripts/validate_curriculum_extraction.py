...
ALLOWED_CHANGE_EXACT = {
    ...
    "data/pipeline_rounds/branch_reconciliation_perek_3_4_baseline_report.md",
    "data/pipeline_rounds/branch_reconciliation_perek_3_4_baseline_report.json",
    ...
    "scripts/validate_branch_reconciliation_report.py",
    ...
    "tests/test_branch_reconciliation_report.py",
