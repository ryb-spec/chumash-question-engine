...
def build_perek3_status() -> dict[str, Any]:
    ...
    revision_plan_path = repo_path("data/gate_2_protected_preview_packets/reports/bereishis_perek_3_item_004_revision_plan.md")
    readiness_path = repo_path(
        "data/gate_2_protected_preview_packets/reports/bereishis_perek_3_limited_post_preview_iteration_readiness.md"
    )
    blocked_register_path = repo_path("data/gate_2_protected_preview_packets/reports/bereishis_perek_3_blocked_from_broader_use_register.md")
    ...
    return {
        ...
        "item_004_revision_plan": repo_relative(revision_plan_path.relative_to(ROOT)),
...
def write_perek3_status_index() -> dict[str, Any]:
    ...
    lines = [
        ...
        f"- Item 004 revision plan: `{data['item_004_revision_plan']}`",
