...
def corpus_title(corpus_id):
    if corpus_id == "parsed_bereishis_3_9_to_3_16_staged":
        return "Bereishis 3:9-3:16 staged reviewed support"
    return "Bereishis 3:1-3:8 staged reviewed support"


def scope_candidate(corpus_id):
    if corpus_id == "parsed_bereishis_3_9_to_3_16_staged":
        return "local_parsed_bereishis_1_1_to_3_16"
    return "local_parsed_bereishis_1_1_to_3_8"
